---
title: eulr
repo: https://github.com/dodyya/eulr
---

<div class="demo-embed"><div class="demo-stage"><iframe src="/demos/eulr/index.html" title="eulr fluid simulation" loading="lazy"></iframe></div><div class="controls"><div><span class="k">drag</span> place obstacles in the flow</div><div><span class="k">&larr; &rarr;</span> visualization mode</div><div><span class="k">&uarr; &darr;</span> color mode</div><div><span class="k">space</span> restart the flow</div><div><span class="k">C</span> clear obstacles</div></div></div>

# Eulerian Fluid Simulation

An Eulerian fluid simulation written in Rust, loosely extending Matthias Muller's work.
